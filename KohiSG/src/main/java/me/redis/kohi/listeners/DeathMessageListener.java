...
public class DeathMessageListener implements Listener {
    ...
    public DeathMessageListener(final SurvivalGames plugin) {
        this.plugin = plugin;
    }
    ...
    private String getDisplayName(final Entity entity) {
        ...
        if (entity instanceof Player) {
            ...
            return player.getName() + ChatColor.GRAY + '[' + ChatColor.WHITE + (SurvivalGames.getPlugin().getProfileManager().getProfile(player.getUniqueId()).getMatchKills()) + ChatColor.GRAY + ']';
        }
