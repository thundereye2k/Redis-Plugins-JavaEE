...
public class DeathMessageListener implements Listener {
    ...
    public DeathMessageListener(final FFA plugin) {
        this.plugin = plugin;
    }
    ...
    private String getDisplayName(final Entity entity) {
        ...
        if (entity instanceof Player) {
            ...
            return player.getName() + ChatColor.GRAY + '[' + ChatColor.WHITE + (FFA.getPlugin().getProfileManager().getProfile(player.getUniqueId()).getKills()) + ChatColor.GRAY + ']';
        }
